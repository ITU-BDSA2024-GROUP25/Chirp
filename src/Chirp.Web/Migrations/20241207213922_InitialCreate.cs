    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorFollowings", x => new { x.AuthorId, x.FollowingId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<int>(type: "INTEGER", nullable: false),
                    LikeAmount = table.Column<int>(type: "INTEGER", nullable: false),
                    DislikeAmount = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
